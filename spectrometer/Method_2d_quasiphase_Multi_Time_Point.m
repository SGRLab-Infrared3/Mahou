classdef Method_2d_quasiphase_Multi_Time_Point < Method_2d_quasiphase
    ...
    methods % GUI Stuff
        function createParamsButton(obj)
            ...
            uicontrol(obj.hParamsPanel, 'style', 'pushbutton','Tag','pbInputButton',...
                ...
                'Position',[x_pos (y_pos+y_origin-(n_params + 1)*(y_offset+height))/2 2*width+x_offset height+0.2],...
