classdef ThorLabs_TCubeDCServo < handle
    ...
    methods
        ...
        function obj = ThorLabs_TCubeDCServo(serialNumber, direction, tagname)
            % START HERE
            ...
            obj.motorSettingsNET = obj.deviceNET.LoadMotorConfiguration(serialNumber); % Get motorSettings via .NET interface
            ...
            elseif strcmp(direction, 'backward')
                ...
                warning('SGRLAB:ThorLabs_TCubeDCServo:BadInputArgument','The input %s for direction is not supported. Using "forward"',direction);
                MotDir = enumHandle.GetEnumValues().Get(1); % 1 stands for "Forwards"
            end
